...
@section('content')
            ...
            <div class="row align-items-center gy-4">
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                    <div class="about-content">
                        <h3>سفر آشپزی ما</h3>
                        <p class="fst-italic">ما در این جا با بهره گیری از بهترین مواد اولیه و به همراه پرسنلی مجرب و با مهارت لیحظات خوشی رو برای شما فراهم میکنیم.</p>
                        <div class="chef-signature mt-4">
                            <div class="row align-items-center">
                                ...
                                <div class="col">
                                    <p class="chef-message mb-2">«آشپزی زبانی است که از طریق آن می‌توان تمام ویژگی‌های زیر را بیان کرد: هماهنگی، خلاقیت، شادی، زیبایی، شعر، پیچیدگی، جادو، طنز، تحریک و فرهنگ.»
            ...
            <div class="row mt-5 pt-4 features-section">
                <div class="col-lg-3 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="200">
                    <div class="feature-box">
                        ...
                        <h4>برنده جایزه</h4>
                        <p>ما  در اینجا در آخر هر ماه بین  میهمانان به قید قرعه جوایزی ا اهدا میکنییم</p>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="300">
                    <div class="feature-box">
                        ...
                        <h4>مواد تازه و اولیه</h4>
                        <p>در این رستوران با استفاده از با کیفیت ترین و تازه ترین مواد اولیه ممحصول با کیفیتی را به شما ارائه میدهیم</p>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="400">
                    <div class="feature-box">
                        ...
                        <h4>تیم مجرب</h4>
                        <p>کارکنان این مجموعه همگی از بهترین ها و با بالاترین مهارت هستند</p>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="500">
                    <div class="feature-box">
                        ...
                        <h4>با عشق پخته شده</h4>
                        <p>هر کسی باید بداند که

                            راه رسیدن به قلب یک انسان،

                            فقط از طریق جغرافیای معده اوست</p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12" data-aos="fade-up" data-aos-delay="200">
                    <div class="stats-container">
                        <div class="stat-item">
                            ...
                            <p class="stat-label">میزان تجربه</p>
                        </div>
                        ...
                        <div class="stat-item">
                            ...
                            <p class="stat-label">سرآشپزهای متخصص</p>
                        </div>
                        ...
                        <div class="stat-item">
                            ...
                            <p class="stat-label">جوایز آشپزی</p>
                        </div>
                        ...
                        <div class="stat-item">
                            ...
                            <p class="stat-label">مشتریان راضی</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="menu" class="menu section">
        ...
        <div class="container section-title" data-aos="fade-up">
            <h2>لیست غذاها</h2>
            <p>لیستی از بهترین غذا ها با کیفیت عالی</p>
        </div>
            ...
            <div class="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
                ...
                <div class="menu-filters isotope-filters mb-5">
                    <ul>
                        ...
                        <li data-filter=".filter-pizza">پیتزا</li>
                        <li data-filter=".filter-sandwich">ساندویچ</li>
                        <li data-filter=".filter-pasta">پاستا</li>
                        <li data-filter=".filter-drinks">نوشیدنی</li>
                        <li data-filter=".filter-salad">سالاد</li>
